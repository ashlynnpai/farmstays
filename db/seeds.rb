...
Farm.create(name: "Reindeer Riders Farm", address: "Reindeer Road, Mongolia", description: "You can visit and ride our reindeer. We offer simple accommodation in teepees. The price is per teepee per night. We can assist you in building a fire in your teepee. Photo by Ling Vien Thai, CC by ND 2.0.", email: "reindeer@fake.com", phone: "0000", website: "reindeerriders.fake", price: 20, photo: "reindeer.jpg", region_id: 5)

Farm.create(name: "Pony Paradise Farm", address: "Ponies Path, Snæfellsjökull, Iceland", description: "Ride our pretty ponies in a scenic environment. Our hotel offers twenty ensuite rooms.  A full breakfast with three kinds of fish is included.  Photo by messicanbeer, CC by. 2.0.", email: "pony@fake.com", phone: "0000", website: "prettypony.fake", price: 100, photo: "pony.jpg", region_id: 6)


Farm.create(name: "Ancient Vineyards", address: "Old Vine Road, Armenia", description: "We have been making wine for 6000 years in the shadow of Mt Ararat. Our guesthouse offers three rooms. Photo by Maks Karochkin, CC by 2.0.", email: "wine@fake.com", phone: "0000", website: "ancientvineyards.fake", price: 50, photo: "wine.jpg", region_id: 7)

Farm.create(name: "Fertile Nile Farm", address: "Nile Road, Egypt", description: "We grow dates and vegetables. Our farm is thirty minutes from Giza and we offer five rooms. We can offer transportation to the Pyramids for a low price. Photo by Carol Walker, CC by 2.0.", email: "nile@fake.com", phone: "0000", website: "fertilenile.fake", price: 30, photo: "date.jpg", region_id: 8)
